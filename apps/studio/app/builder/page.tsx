...
import type { VoiceProfile } from '@/lib/voice-lab-client'
...
function ContentBuilderPageContent() {
  ...
  // Pre-fill title from thesis query param (from Research Assistant "Draft This" action)
  useEffect(() => {

-- =====================================================
-- CASSIE KOZYRKOV - Camp Relationships
-- =====================================================
-- Adding 4 camp relationships for Cassie Kozyrkov
-- Author already exists in database, adding camp_authors entries
-- Reference: TIER1_AUTHORS_SUMMARY.md, TIER1_CAMP_MAPPINGS.md

BEGIN;

-- Get Cassie's author ID
DO $$
DECLARE
  cassie_id uuid;
BEGIN
...
-- Verification: Check Cassie's camp relationships
SELECT
  a.name,
  c.name as camp_name,
